...
DefinitionBlock ("", "SSDT", 2, "hack", "BATT", 0)
{
    ...
    {      
        Method (_BIX, 0, NotSerialized)
        {
            ...
            Store (B1B2 (^^LPCB.EC.B030, ^^LPCB.EC.B031), Index (BIXT, 0x0A))
    ...
    Scope(\_SB.PCI0.LPCB.EC)
    {
        Method (SMBR, 3, Serialized)
        {
            ...
            Acquire (MUEC, 0xFFFF)
            Store (\_SB.PCI0.LPCB.EC.PRTC, Local1)
            Store (Zero, Local2)
            While (LNotEqual (Local1, Zero))
            {
                ...
                {
                    Store (\_SB.PCI0.LPCB.EC.SBBY, Index (Local0, Zero))
                    Store (Zero, Local1)
                }
                Else
                {
            ...
            If (LLessEqual (Local2, 0x03E8))
            {
                ...
                Store (Arg0, \_SB.PCI0.LPCB.EC.PRTC)
                Store (SWTC (Arg0), Index (Local0, Zero))
                If (LEqual (DerefOf (Index (Local0, Zero)), Zero))
                {
                    If (LEqual (Arg0, RDBL))
                    {
                        Store (\_SB.PCI0.LPCB.EC.BCNT, Index (Local0, One))
                    ...
                    If (LEqual (Arg0, RDWD))
                    {
                        ...
                        Store (B1B2 (\_SB.PCI0.LPCB.EC.DT20, \_SB.PCI0.LPCB.EC.DT21), Index (Local0, 0x02))
                        //DT2B
                    }
                    ...
                    If (LEqual (Arg0, RDBT))
                    {
                        ...
                        Store (\_SB.PCI0.LPCB.EC.DAT0, Index (Local0, 0x02))
                    }
        ...
        Method (SMBW, 5, Serialized)
        {
            ...
            If (LLessEqual (Local2, 0x03E8))
            {
                ...
                If (LEqual (Arg0, WRBL))
                {
                    Store (Arg3, \_SB.PCI0.LPCB.EC.BCNT)
                    WECB (0x04, 0x0100, Arg4) //BDAT
                }

                If (LEqual (Arg0, WRWD))
                {
                    Store (Arg4, B1B2 (\_SB.PCI0.LPCB.EC.DT20, \_SB.PCI0.LPCB.EC.DT21))   
                    //DT2B
                }

                If (LEqual (Arg0, WRBT))
                {
                    Store (Arg4, \_SB.PCI0.LPCB.EC.DAT0)
                }
        ...
        Method (ECSB, 7, NotSerialized)
        {
            ...
            If (ECAV ())
            {
                ...
                If ((Arg0 == Zero))
                {
                    Local0 = \_SB.PCI0.LPCB.EC.PRTC /* \_SB_.PCI0.LPCB.EC0_.PRTC */
                }
                Else
                {
                    Local0 = \_SB.PCI0.LPCB.EC.PRT2 /* \_SB_.PCI0.LPCB.EC0_.PRT2 */
                }
                ...
                While ((Local0 != Zero))
                {
                    ...
                    If ((Local2 > 0x03E8))
                    {
                        Local1 [Zero] = \_SB.PCI0.LPCB.EC.SBBY /* \_SB_.PCI0.LPCB.EC0_.SBBY */
                        Local0 = Zero
                    }
                    ElseIf ((Arg0 == Zero))
                    {
                ...
                If ((Local2 <= 0x03E8))
                {
                    If ((Arg0 == Zero))
                    {
                        ...
                        {
                            \_SB.PCI0.LPCB.EC.BCNT = DerefOf (Arg6 [Zero])
                            WECB (0x04, 0x0100, DerefOf (Arg6 [One])) //BDAT
                        }
                        Else
                        {
                            \_SB.PCI0.LPCB.EC.DAT0 = Arg4
                            \_SB.PCI0.LPCB.EC.DAT1 = Arg5
                        }

                        \_SB.PCI0.LPCB.EC.PRTC = Arg1
                    }
                    Else
                    {
                        ADD2 = Arg2
                        ...
                        If (((Arg1 == 0x0A) || (Arg1 == 0x0B)))
                        {
                            \_SB.PCI0.LPCB.EC.BCN2 = DerefOf (Arg6 [Zero])
                            WECB (0x04, 0x0100, DerefOf (Arg6 [One])) //BDA2
                        }
                        Else
                        {
                            \_SB.PCI0.LPCB.EC.DA20 = Arg4
                            \_SB.PCI0.LPCB.EC.DA21 = Arg5
                        }

                        \_SB.PCI0.LPCB.EC.PRT2 = Arg1
                    }

                    Local0 = 0x7F
                    If ((Arg0 == Zero))
                    {
                        While (\_SB.PCI0.LPCB.EC.PRTC)
                        {
                            Sleep (One)
                            Local0--
                        }
                    ...
                    If (Local0)
                    {
                        If ((Arg0 == Zero))
                        {
                            Local0 = \_SB.PCI0.LPCB.EC.SSTS /* \_SB_.PCI0.LPCB.EC0_.SSTS */
                            Local1 [One] = \_SB.PCI0.LPCB.EC.DAT0 /* \_SB_.PCI0.LPCB.EC0_.DAT0 */
                            Local1 [0x02] = \_SB.PCI0.LPCB.EC.DAT1 /* \_SB_.PCI0.LPCB.EC0_.DAT1 */
                            Local1 [0x03] = \_SB.PCI0.LPCB.EC.BCNT /* \_SB_.PCI0.LPCB.EC0_.BCNT */                            
                            Local1 [0x04] = RECB(0x04,0x100) //BDAT                            
                        }
                        Else
                        {
                            Local0 = \_SB.PCI0.LPCB.EC.SST2 /* \_SB_.PCI0.LPCB.EC0_.SST2 */
                            Local1 [One] = \_SB.PCI0.LPCB.EC.DA20 /* \_SB_.PCI0.LPCB.EC0_.DA20 */
                            Local1 [0x02] = \_SB.PCI0.LPCB.EC.DA21 /* \_SB_.PCI0.LPCB.EC0_.DA21 */
                            Local1 [0x03] = \_SB.PCI0.LPCB.EC.BCN2 /* \_SB_.PCI0.LPCB.EC0_.BCN2 */
