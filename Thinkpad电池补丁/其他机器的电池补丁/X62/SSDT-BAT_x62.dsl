...
DefinitionBlock ("", "SSDT", 2, "hack", "BATT", 0)
{
    ...
    External(_SB.PCI0.LPCB.EC.BSTS, FieldUnitObj)
    External(_SB.PCI0.LPCB.EC.BAT0.BATX, MutexObj)
    External(_SB.PCI0.LPCB.EC.BAT0.BBIF, PkgObj)
    External(_SB.PCI0.LPCB.EC.BAT0.BBST, PkgObj)
