...
DefinitionBlock ("", "SSDT", 2, "hack", "BATT", 0)
{
    ...
    External(_SB.PCI0.LPCB.EC.SYS7, FieldUnitObj)
    External(_SB.PCI0.LPCB.EC.GAU0, FieldUnitObj)
    External(_SB.PCI0.LPCB.EC.DBCD, FieldUnitObj)
    External(_SB.PCI0.LPCB.EC.BMF0, FieldUnitObj)
    ...
    Scope(\_SB.PCI0.LPCB.BAT1)
    {
        Method (_BIF, 0, NotSerialized)
        {
            ...
            If ((ECOK () && (ECDY == Zero)))
            {
                Local0 = B1B2 (^^EC.DC00,^^EC.DC01)
                            Sleep (0x14)
                Local1 = B1B2 (^^EC.FC00,^^EC.FC01)
                            Sleep (0x14)
                            Local0 *= 0x0A
                            Local1 *= 0x0A
                            STAT [One] = Local0
                            STAT [0x02] = Local1
                STAT [0x04] = B1B2 (^^EC.DV00,^^EC.DV01)
                            Sleep (0x14)
                Local2 = B1B2 (^^EC.SN00,^^EC.SN01)
                            Sleep (0x14)
                Local3 = B1B2 (^^EC.FC00,^^EC.FC01)
                            Sleep (0x14)
                            Local3 = (Local3 *= 0x32 / 0x64)
                            STAT [0x05] = Local3
                Local4 = B1B2 (^^EC.FC00,^^EC.FC01)
                            Sleep (0x14)
                            Local4 = (Local4 *= 0x1E / 0x64)
                            STAT [0x06] = Local4
                            STAT [0x09] = ^^EC.XXXX()
                Local0 = B1B2 (^^EC.SN00,^^EC.SN01)
                            Local1 = Zero
                            While ((Local1 < 0x04))
                            {
        ...
        Method (_BST, 0, NotSerialized)
        {
            ...
            If ((ECOK () && (ECDY == Zero)))
            {
                Local0 = ^^EC.BST0
                            Sleep (0x14)
                Local1 = B1B2 (^^EC.AC00,^^EC.AC01)
                            Sleep (0x14)
                Local2 = B1B2 (^^EC.RC00,^^EC.RC01)
                            Sleep (0x14)
                Local3 = B1B2 (^^EC.PV00,^^EC.PV01)
                            Sleep (0x14)
                Local4 = ^^EC.GAU0
                            Sleep (0x14)
                            If ((Local1 && 0x8000))
